            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                            <a href="{{ route("workspace") }}" class="nav-link edit">Groups</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route("schedule") }}" class="nav-link edit">Schedule</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route("tasks") }}" class="nav-link edit">Tasks</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route("subjects") }}" class="nav-link edit">Subjects</a>
                        </li>
